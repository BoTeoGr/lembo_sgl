...
if (userForm) {
    ...
    userForm.addEventListener("submit", function (e) {
        ...
        const { userName, userType, userImage, idInsumo, UserExtent, userPrice, userAmount } = userData;

        // Validación de los campos
        if (!userName || !userType || !userImage || !idInsumo || !UserExtent || !userPrice || !userAmount) {
