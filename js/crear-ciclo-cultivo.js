...
if (userForm) {
    ...
    userForm.addEventListener("submit", function (e) {
        ...
        const { userName, userId, userDescription, userDateInicio, userDateFinal, UserNovedades } = userData;

        // Validación de los campos
        if (!userName || !userId || !userDescription || !userDateInicio || !userDateFinal || !UserNovedades) {
