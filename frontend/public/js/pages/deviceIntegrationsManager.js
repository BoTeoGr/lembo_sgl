...
const lecturasSensores = [
    { nombre: "Temperatura", tipo: "temperatura", valor: "24.5", unidad: "°C", actualizado: "Hace 5 min", icono: "thermometer-half", iconoColor: "#ef4444" },
    { nombre: "Humedad del suelo", tipo: "humedad", valor: "65", unidad: "%", actualizado: "Hace 10 min", icono: "tint", iconoColor: "#3b82f6" },
    { nombre: "Velocidad del viento", tipo: "viento", valor: "12", unidad: "km/h", actualizado: "Hace 15 min", icono: "wind", iconoColor: "#8b5cf6" },
    { nombre: "Temperatura del suelo", tipo: "temperatura", valor: "22.1", unidad: "°C", actualizado: "Hace 20 min", icono: "thermometer-half", iconoColor: "#ef4444" },
    { nombre: "Nivel de CO2", tipo: "aire", valor: "410", unidad: "ppm", actualizado: "Hace 30 min", icono: "gauge", iconoColor: "#14b8a6" }
];
    ...
    integrationForm.addEventListener("submit", (e) => {
        ...
        if (currentIntegrationType === "sensor") {
            ...
            const nuevaIntegracion = {
                ...
                ubicacion: selectedSensor.ubicacion, // Corregido
                intervalo: "15",
...
function renderSelectionList() {
    ...
    if (currentIntegrationType === "sensor") {
        const filteredSensores = sensoresDisponibles.filter(sensor => 
        ...
        const filteredInsumos = insumosDisponibles.filter(insumo => 
